...
class ProxyServerIntegrationTest extends AbstractIntegrationTest {
    ...
    void testCorsPreflightRequest() throws Exception {
        ...
        corsTestSupport.assertCorsPreflightRequest("/api/data", "https://example.com");
    }
    ...
    void testCorsHeadersInRegularResponse() throws Exception {
        CorsTestSupport corsTestSupport = new CorsTestSupport(httpClient, getProxyUrl());
        HttpResponse<String> response = corsTestSupport.assertCorsHeadersInGetResponse("/test", "https://unicitynetwork.github.io");
